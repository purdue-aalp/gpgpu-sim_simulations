...
template __device__ INLINE2 void apply<3,2,1>(const uint src, uint* const _shared_);

template __device__ INLINE2 void apply<4,2,3>(const uint src, uint* const _shared_);
